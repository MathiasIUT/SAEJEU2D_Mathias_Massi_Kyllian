...
class Router {
    ...
    private function checkAccess($module, $action) {
        ...
        $permissions = [
            'admin' => ['*'],
            'enseignant' => ['dashboard', 'projet', 'rendu', 'messagerie', 'soutenance', 'ressource'],
            'etudiant' => ['dashboard', 'rendu', 'messagerie', 'soutenance', 'ressource']
        ];
